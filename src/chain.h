...
public:
    ...
    //! Pack status/file into 32 bits to reduce CBlockIndex size.
    //! 用 32 位打包状态与文件号以缩小 CBlockIndex。
...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        // Serialize packed fields via temporaries to keep bitfields assignable.
        // 使用临时变量序列化打包字段，避免 bitfield 直接写入失败。
